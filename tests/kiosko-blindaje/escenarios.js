...
//
// Escenarios deterministas: el caso real del empleado 124 (hr.employee 124, 17 al 23 de
...
// ─── Caso empleado 124, tal como pasó con el diseño de HOY ───────────────────────
function caso124Hoy() {
  return [
    ...
    { tipo: 'rh', op: 'resolver', inc: '@auto_cierre', accion: 'ajustar', hhmm: '17:01', t: cst(2026, 9, 18, 10, 42, 2),
      desc: 'Vie 18 10:42 RH-1 ajusta el auto-cierre a 17:01 (resolver 104680)' },
    { tipo: 'rh', op: 'resolver', inc: '@olvido_entrada', accion: 'ajustar', hhmm: '07:30', t: cst(2026, 9, 18, 11, 46, 1),
      desc: 'Vie 18 11:46 RH-2 ajusta la entrada a 07:30 (resolver 104773)' },
...
// ─── Caso empleado 124 con el diseño nuevo: mismas intenciones, botones nuevos ───
function caso124Nuevo() {
  return [
...
module.exports = { caso124Hoy, caso124Nuevo, estadoTrabado, POR_BLOQUE, EMP };
