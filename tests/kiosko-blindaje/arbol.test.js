...
//
// Árbol de falla del caso Germán, medido con el simulador: se quita UNA pieza a la
...
const { germanHoy, EMP } = require('./escenarios');

const T = (d, h, m, s) => cst(2026, 9, d, h, m, s || 0);
const base = germanHoy();
...
const VARIANTES = [
  ...
  { id: 'P3', pieza: 'El kiosko pinta éxito cuando falla (Germán se fue creyendo que entró)', diseno: { B1: true },
