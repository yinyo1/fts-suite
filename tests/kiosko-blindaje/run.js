...
//
// Código de salida 1 solo si: el caso Germán no se reproduce, un bloque construido
...
let fallo = false;
for (const f of ['caso-german.test.js', 'arbol.test.js', 'bloques.test.js', 'aleatorio.test.js']) {
  try {
