// tests/kiosko-blindaje/caso-german.test.js
//
...
//      violación.
//
// Run: node tests/kiosko-blindaje/caso-german.test.js [--narrar]

'use strict';

const { Sistema, disenoActual, disenoNuevo } = require('./sistema');
const { Monitor } = require('./monitor');
const { germanHoy, germanNuevo, EMP } = require('./escenarios');
...
console.log('\n=== Caso Germán con el diseño nuevo (B1..B10) ===');
const nuevo = new Monitor(new Sistema(disenoNuevo()), [EMP]).correr(germanNuevo());
