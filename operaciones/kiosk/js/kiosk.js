...
async function mostrarEstadoEmpleado(empleado){
  ...
  if(estado.historial && estado.historial.length > 0){
    ...
    html += '<div style="max-height:min(200px, 30vh);overflow-y:scroll;overflow-x:hidden;border:1px solid #e0e0e0;border-radius:8px;padding:4px;-webkit-overflow-scrolling:touch">';
