...
| **`tests/`** | 497 pruebas. Casos de regresión **D (LEGO)**, **F (Cuprum)** y **G (Hershey)**, más el truco del contador vacío, el lazo de refuerzo y la guardia de datos personales |
...
```bash
python3 -m pytest tests -q     # 497 pruebas
```
